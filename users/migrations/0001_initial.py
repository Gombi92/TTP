    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('male', 'Muž'), ('female', 'Žena'), ('other', 'Jiné')], max_length=10)),
                ('formal_choice', models.CharField(choices=[('tykani', 'Tykání'), ('vykani', 'Vykání')], max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ...
                ('communication_preference', models.CharField(blank=True, choices=[('formal', 'Vykání'), ('informal', 'Tykání')], max_length=10, null=True)),
